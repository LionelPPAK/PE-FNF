...
class FlxVirtualPad extends FlxSpriteGroup
{
	...
	public function new(DPad:FlxDPadMode, Action:FlxActionMode)
	{
		...
		switch (DPad)
		{
			...
			case RIGHT_FULL:
				add(buttonUp = createButton(FlxG.width - 258, FlxG.height - 345, 132, 127, 'up', 0x00FF00));
				add(buttonLeft = createButton(FlxG.width - 384, FlxG.height - 243, 132, 127, 'left', 0xFF00FF));
				add(buttonRight = createButton(FlxG.width - 132, FlxG.height - 243, 132, 127, 'right', 0xFF0000));
